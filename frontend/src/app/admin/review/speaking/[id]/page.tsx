        ...
        <div className={`mb-6 p-4 rounded-xl border flex flex-col sm:flex-row sm:items-center justify-between gap-3 ${
          ...
          <div>
            ...
            <p className="text-xs opacity-80 mt-0.5">
              Oynadan chiqish (Tab switch): <strong>{speaking?.tab_switches ?? 0} marta</strong> &bull; Nusxa ko&apos;chirish (Paste): <strong>{speaking?.paste_attempts ?? 0} marta</strong>
            </p>
          </div>
          <span className={`text-xs font-semibold px-3 py-1 rounded-full self-start sm:self-auto ${
            ...
            {speaking?.is_flagged_cheating ? 'Shubhali' : 'Me\'yorda'}
          </span>
        </div>
